...
class Table(object):
    def config_db(self, pkg):
        '''divisioni: divisioni per soggetto'''

        tbl = pkg.table('divisioni', pkey='id',
                        pkey_columns='sog__cod,cod',
                        #partition_sog__cod='sog__cod',
                        name_long='!![it]Divisione',
                        name_plural='!![it]Divisioni',
        ...
        tbl.formulaColumn('caption', "$cod", #"$cod||' - '||$desc",
                          name_long='!![it]Divisione')
