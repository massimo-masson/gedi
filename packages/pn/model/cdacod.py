...
class Table(object):
    def config_db(self, pkg):
        '''cdacod: codice dello schema del piano dei centri di analisi
        
        Il centro di analisi e' l'entita' deputata alla rilevazione delle
        componenti economico/finanziarie per destinazione.

        In relazione 1:n con la tabella cdacentro, che contiene i record dello 
        specifico piano dei centri di analisi
        '''

        tbl = pkg.table('cdacod', pkey='cod', 
