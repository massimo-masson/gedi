...
class Table(object):
    def config_db(self, pkg):
        '''pdc_natura_conti: tabella per definizione della natura dei conti
        
        Questa tabella e' generale: non collegata ad uno specifico sog
        '''

        tbl = pkg.table('pdc_natura_conti', pkey='cod', 
                        name_long='!![it]Natura conti',
                        #name_plural='!![it]Tassonomia',
                        caption_field='cod')

        # 20250312  da gerarchica a flat. 
        #           per tabella gerarchica obbligatoria pk "id"
        #           voglio pk "cod"
