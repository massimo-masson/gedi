...
class Table(object):
    def config_db(self, pkg):
        '''pdv_voci: voci di uno dei piani delle voci
        ...
        tbl = pkg.table('pdv_voci', 
                        pkey='cpk',
                        #pkey='id', 
                        #pkey_columns='pdv_cod__cod,cod',
                        name_long='!![it]Voce',
                        name_plural='!![it]Voci',
        ...
        # pdc_cod__cod: foreign key to pdv_cod
        ...
        # PK composta
        #
        tbl.compositeColumn('cpk', columns='pdv_cod__cod,cod',
                            name_long = '!![it]Voce',
                            )
