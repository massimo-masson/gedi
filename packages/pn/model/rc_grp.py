...
class Table(object):
    def config_db(self, pkg):
        '''rc_grp: registrazione contabile - gruppo registrazione
        ...
        # foreign key to rc_grp_cls - classe del grupp di registrazione
        rc_grp_cls__cod = tbl.column('rc_grp_cls__cod', dtype = 'A', size = ':32',
                                     name_long = '!![it]Classe gruppo registrazione',
                                     validate_notnull = True
                                     )
        rc_grp_cls__cod.relation('pn.rc_grp_cls.cod', mode = 'foreignkey',
        ...
        tbl.aliasColumn('classe_desc', 
                        relation_path='@rc_grp_cls__cod.desc',
