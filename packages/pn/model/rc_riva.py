...
class Table(object):
    def config_db(self, pkg):
        '''rc_riva: rilevazione contabile - riga IVA

        Righe movimenti IVA        
        '''

        tbl = pkg.table('rc_riva', pkey='id', 
                        pkey_columns='rc__id',
        ...
        # foreign key to iva_cod: codice IVA del movimento
        iva_cod__cod = tbl.column('iva_cod__cod', dtype = 'A', size = ':32',
                                  name_long = '!![it]Codice IVA',
                                  #unmodifiable=True,
                                  validate_notnull = True
                                  )
        iva_cod__cod.relation('pn.iva_cod.cod', mode = 'foreignkey',
        ...
        tbl.aliasColumn('iva_aliquota', dtype='N',
                        ...
                        name_short='!![it]% IVA',
                        relation_path='@iva_cod__cod.aliquota',
                        )
