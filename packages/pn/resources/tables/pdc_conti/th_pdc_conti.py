...
class Form(BaseComponent):
    ...
    def th_form(self, form):
        ...
        #fb.div('')
        fb.field('@pdc_natura_conti__cod.desc', readOnly=True, validate_notnull=False)
