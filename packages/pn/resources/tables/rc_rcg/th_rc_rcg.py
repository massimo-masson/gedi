...
class View(BaseComponent):
    ...
    def th_struct(self,struct):
        ...
        r.fieldcell('pdc_conti__cod')
        #r.fieldcell('pdc_conti_fk')
        ...
        r.fieldcell('pdv_voci__cod')
        r.fieldcell('divisioni__id')
        r.fieldcell('divisioni_rc')
...
class Form(BaseComponent):
    ...
    def FHeader(self, pane):
        ...
        fb.field('commesse_rc', readOnly=True)
        fb.field('divisioni_rc', readOnly=True)

        fb.dbSelect('^.pdc_conti__cod', dbtable='pn.pdc_conti',
                    lbl='!![it]Conto',
                    hasDownArrow=True,
                    columns = '$cod,$desc',
                    auxColumns = '$cod,$desc',
        ...
        # fb.field('pdc_conti__fk', hasDownArrow=True, readOnly=False,
        #          columns = '$cod,$desc',
        #          condition = '$pdc_cod__cod = :pdc',
        #          #condition_pdc = '=#FORM.record.pdccod__cod', # funziona
        #          condition_pdc = '=.@rc__id.@sog__cod.pdc_cod__cod',
    ...
    def FBody(self, pane):
        ...
        aa = analitica.tabContainer(tabPosition='left-h') # top bottom right-h, left-h
